...
function Navigation() {
  return (
    <nav className="mt-px font-display text-5xl font-medium tracking-tight text-white">
      ...
      <NavigationRow>
        <NavigationItem href="/process">Approach</NavigationItem>
              ...
              <Container>
                <div className="grid grid-cols-1 gap-y-10 pt-10 pb-16 sm:grid-cols-2 sm:pt-16">
                  <div>
                    ...
                    <p className="mt-6 max-w-sm text-sm text-neutral-300">
                      CRM integrations, Make automations, API and webhook
                      workflows, TypeScript and SQL-backed applications, and
