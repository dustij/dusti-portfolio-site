...
export const HERO_CONTENT = `I am a CIS student and passionate programmer with a strong foundation in software development. Since 2020, I’ve built applications with Python, explored full-stack development with TypeScript, React, Next.js, and Node.js, and gained backend experience with Django, MySQL, and Drizzle ORM. Currently pursuing a bachelor’s degree, I’m refining my skills in Java and software design to become a versatile developer ready to tackle any challenge.`;
